...
- All canonical cases valid: `True`
- `hc_hubbard_L2_static_t1.0_U4.0_S64_heavy.json`: L=2, drive=False, |VQE-exact|=3.20842046264147e-08, max|E_trot-E_exact_ans|=0.07798533165196853, final_fidelity=0.9869249072500748
- `hc_hubbard_L3_static_t1.0_U4.0_S128_heavy.json`: L=3, drive=False, |VQE-exact|=1.2720054520798385e-07, max|E_trot-E_exact_ans|=0.008288216471344256, final_fidelity=0.9985135925614043
- `hc_hubbard_L4_drive_t1.0_U4.0_S256_dyn.json`: L=4, drive=True, |VQE-exact|=0.00010348314457075958, max|E_trot-E_exact_ans|=0.0029578796116696005, final_fidelity=0.9993357304628818
