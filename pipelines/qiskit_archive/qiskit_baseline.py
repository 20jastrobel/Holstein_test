...
# ---------------------------------------------------------------------------
# Path setup — this file lives at pipelines/qiskit_archive/qiskit_baseline.py
# ---------------------------------------------------------------------------
...
def _write_pipeline_pdf(pdf_path: Path, payload: dict[str, Any], run_command: str) -> None:
    ...
    with PdfPages(str(pdf_path)) as pdf:
        ...
        render_text_page(pdf, summary_lines, fontsize=10)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "hardcoded/hubbard_pipeline.py --problem hh."
        ),
    )
...
def main() -> None:
    ...
    output_json = args.output_json or (json_dir / f"qk_hubbard_L{args.L}.json")
    output_pdf = args.output_pdf or (pdf_dir / f"qk_hubbard_L{args.L}.pdf")
