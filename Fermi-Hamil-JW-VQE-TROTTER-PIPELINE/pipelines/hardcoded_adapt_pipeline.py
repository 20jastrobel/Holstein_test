...
#   Fermi-Hamil-JW-VQE-TROTTER-PIPELINE/pipelines/hardcoded_adapt_pipeline.py
# REPO_ROOT is the top-level Holstein_test directory.
# ---------------------------------------------------------------------------
ROOT = Path(__file__).resolve().parents[1]     # Fermi-Hamil-JW-VQE-TROTTER-PIPELINE/
REPO_ROOT = ROOT.parent                         # Holstein_test/
...
def _write_pipeline_pdf(pdf_path: Path, payload: dict[str, Any], run_command: str) -> None:
    with PdfPages(str(pdf_path)) as pdf:
        ...
        _render_text_page(pdf, manifest_lines, fontsize=10, line_spacing=0.03)
