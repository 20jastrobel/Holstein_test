...
ROOT = Path(__file__).resolve().parent.parent  # Holstein_test/
ARTIFACTS_ROOT = ROOT / "artifacts"

DEFAULT_JSON_PATHS = [
    ARTIFACTS_ROOT / "json" / "hc_hubbard_L3_static_t1.0_U4.0_S128.json",
    ARTIFACTS_ROOT / "json" / "hc_hubbard_L2_static_t1.0_U4.0_S64.json",
]
DEFAULT_OUTPUT_DIR = ARTIFACTS_ROOT / "testing3d"
